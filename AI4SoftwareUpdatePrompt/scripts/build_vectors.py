...
# paths & parameters
###############################################################################
# Store everything under data/release_notes_store
OUT_DIR = os.path.join("data", "release_notes_store")   # folder for dataset + index
FAISS_PATH = os.path.join(OUT_DIR, "faiss.index")
EMB_MODEL = "sentence-transformers/all-mpnet-base-v2"

# Your survey CSV is inside data/
CSV_PATH = os.path.join("data", "SoftwareUpdateSurvey.csv")
...
def fetch_api(url: str, max_items: int, field_map: dict):
    try:
